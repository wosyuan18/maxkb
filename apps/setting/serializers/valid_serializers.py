...
model_message_dict = {
    'dataset': {'model': DataSet, 'count': 9999,
                'message': _(
                    'The community version supports up to 9999 knowledge bases. If you need more knowledge bases, please contact us (https://fit2cloud.com/).')},
    'application': {'model': Application, 'count': 9999,
                    'message': _(
